...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<div class="btn-toolbar">
				<b><h1 class="text-center">View Messages</h1></b>
				<br>
				<!-- testing===================================================================-->
				<?php echo 
				"You are logged in as ".$_SESSION['username'].". Here you can view and manage messages sent to you by students. <br/>The newest message will appear at the top<br/><br>";
				?>
    ...
    //select query.
					$query = "SELECT privatemessageid, privatemessage, userid, teacherid FROM zPrivateMessage WHERE teacherid ='".$_SESSION['teacherid']."' ORDER BY privatemessageid DESC ";
					...
					<tr>
						<td><?php echo $row['privatemessageid']; ?></td>
						<td><?php echo $row['privatemessage']; ?></td>
						<td>
							<a class="btn btn-danger" href="deletemessage.php?del=<?php echo $row['privatemessageid']; ?>">Delete</a>
						</td>
