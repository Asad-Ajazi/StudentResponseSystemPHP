...
<div class="container">
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<div class="btn-toolbar">
				<b><h1 class="text-center">Manage Users</h1></b>
				<br>
				<!-- testing===================================================================-->
    ...
    //select query.
				$query = "SELECT userid, username, email FROM zUser";
				...
				<tr>
					...
					<td>
						<a class="btn btn-danger" href="deleteuser.php?del=<?php echo $row['userid']; ?>">Delete</a>
					</td>
